module Contexts
    module Quizzes
      ...
      def create_quizzes 
        ...
        @millvale_e1_j3_r1 = FactoryBot.create(:quiz, event: @millvale_e1, room: 3, round: 1)
        @millvale_e1_j4_r2 = FactoryBot.create(:quiz, event: @millvale_e1, room: 4, round: 2)
      end
      ...
      def destroy_quizzes
        ...
        @millvale_e1_j3_r1.destroy
        @millvale_e1_j4_r2 .destroy
      end
